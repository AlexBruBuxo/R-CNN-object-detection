"""
This config file asumes you execute it from the 'tests' directory.
"""

import os

#define the source path to the image folder
IMAGES_PATH = 'images'
...
ORIG_BASE_PATH = os.path.sep.join([IMAGES_PATH, "raccoons"])
...
# boulder scripts and then use the base path to derive the paths to 
# our output class label directories
BASE_PATH = os.path.sep.join([IMAGES_PATH, "dataset"])
...
# set the threshold used on non-maxima suppression for a maximum
# overlap of ROIs
OVERLAP_THRESH = 0.2